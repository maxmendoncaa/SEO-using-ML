...
# Example usage
ctr=sum1forline("trimmed.csv")-1 #count entries

dclusters =divisive("trimmed.csv", int(0.7*ctr))
#print("Divisive:", dclusters)

aclusters = aglo("trimmed.csv", int(0.7*ctr))
#print("Agglomerative:", aclusters)

kclusters = k_means("trimmed.csv", int(0.7*ctr))
